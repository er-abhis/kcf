...
@Component({
  selector: 'app-provider-faqs',
  templateUrl: './provider-faqs.component.html',
  styleUrls: ['./provider-faqs.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ProviderFAQsComponent implements OnInit {
  count: number = 0;
  html: any;
  constructor() { }
