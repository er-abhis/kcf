...
@Component({
  selector: 'app-licence-modal-tooltip',
  templateUrl: './licence-modal-tooltip.component.html',
  styleUrls: ['./licence-modal-tooltip.component.scss']
})
export class LicenceModalTooltipComponent implements OnInit {
