...
// @Component({
//   selector: 'app-mat-search-select',
//   templateUrl: './mat-search-select.component.html',
//   styleUrls: ['./mat-search-select.component.scss'],
//   providers: [
//     {
...
//     changeDetection: ChangeDetectionStrategy.OnPush
// })
export class MatSearchSelectComponent implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
  ...
  onInputChange(value: any) {
    let valueEvent = value?.target?.value
    const valueChanged = valueEvent !== this._value;

    if (valueChanged) {
      this._value = valueEvent;
      this.onChange(valueEvent);
