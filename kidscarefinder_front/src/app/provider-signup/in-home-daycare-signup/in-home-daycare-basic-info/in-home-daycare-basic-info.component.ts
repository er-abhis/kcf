...
@Component({
  selector: 'app-in-home-daycare-basic-info',
  templateUrl: './in-home-daycare-basic-info.component.html',
  styleUrls: ['./in-home-daycare-basic-info.component.scss']
})
export class InHomeDaycareBasicInfoComponent implements OnInit {
