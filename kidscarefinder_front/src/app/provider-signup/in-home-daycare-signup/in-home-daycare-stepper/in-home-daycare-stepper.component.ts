...
@Component({
  selector: 'app-in-home-daycare-stepper',
  templateUrl: './in-home-daycare-stepper.component.html',
  styleUrls: ['./in-home-daycare-stepper.component.scss']
})
export class InHomeDaycareStepperComponent implements OnInit {
  @ViewChild('stepper', { static: true })
  private stepper!: MatStepper;
  hideBackBtn: boolean = true;
  @ViewChild(InHomeDaycareBasicInfoComponent, { static: true })
  basicInfo!: InHomeDaycareBasicInfoComponent;
  @ViewChild(InHomeDaycareScheduleAvailabilityComponent, { static: true })
  scheduleAvailable!: InHomeDaycareScheduleAvailabilityComponent;
