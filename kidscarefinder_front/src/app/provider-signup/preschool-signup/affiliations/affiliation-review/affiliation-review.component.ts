...
@Component({
  selector: 'app-affiliation-review',
  templateUrl: './affiliation-review.component.html',
  styleUrls: ['./affiliation-review.component.scss']
})
export class AffiliationReviewComponent implements OnInit {
  stepCount: number = 0;
