    ...
    switch (stepCount) {
      case 0:
        if (
          ...
          this.notificationService.showSuccess(CustomAlertMessage.Notification[0].message);
        } else {
          this.notificationService.showError(CustomAlertMessage.Notification[1].message);
          return;
        }
