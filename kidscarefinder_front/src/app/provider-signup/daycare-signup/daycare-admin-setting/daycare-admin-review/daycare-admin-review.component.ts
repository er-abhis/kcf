...
@Component({
  selector: 'app-daycare-admin-review',
  templateUrl: './daycare-admin-review.component.html',
  styleUrls: ['./daycare-admin-review.component.scss'],
})
export class DaycareAdminReviewComponent implements OnInit {
