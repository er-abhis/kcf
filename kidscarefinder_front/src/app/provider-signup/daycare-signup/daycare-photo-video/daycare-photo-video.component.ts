...
@Component({
  selector: 'app-daycare-photo-video',
  templateUrl: './daycare-photo-video.component.html',
  styleUrls: ['./daycare-photo-video.component.scss'],
})
export class DaycarePhotoVideoComponent implements OnInit {
  stepCount: number = 0;
    ...
    switch (stepCount) {
            ...
            .subscribe({
              ...
              error: (error: any) => {
                ...
                if (error?.error.errors && error.error.errors.upload_file[0]) {
                  ...
                  console.log('Error', error.error.errors.upload_file);
                } else {
                  this.notificationService.showError(
                    CustomAlertMessage.photoVideo[1].message
                  );
      ...
      case 1:
        ...
        if (
          ...
          this.notificationService.showWarning(
            CustomAlertMessage.photoVideo[2].message
          );
          return;
        }
