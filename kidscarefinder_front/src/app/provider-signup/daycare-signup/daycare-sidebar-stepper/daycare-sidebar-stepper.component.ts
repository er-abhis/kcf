...
@Component({
  selector: 'app-daycare-sidebar-stepper',
  templateUrl: './daycare-sidebar-stepper.component.html',
  styleUrls: ['./daycare-sidebar-stepper.component.scss']
})
export class DaycareSidebarStepperComponent implements OnInit {
